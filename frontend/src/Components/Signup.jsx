...
const navigate = useNavigate("/home")
    ...
    return (
            ...
            <input className="text-sm border-2 border-r-2 rounded-md border-slate-800 w-full px-2 py-1"name="email" id="emailSignup" type="text" placeholder="xyz@gmail.com" onChange={(e) => {
            ...
            <input className="text-sm border-2 border-r-2 rounded-md border-slate-800 w-full px-2 py-1"name="email" id="firstNamesign" type="text" placeholder="xyz" onChange={(e) => {
                setFirstName(e.target.value)
            }} />
            </div>
            <div className="py-2 text-left">
            <label className="font-semibold text-2xl" htmlFor="email">Last Name:</label><br />
            <input className="text-sm border-2 border-r-2 rounded-md border-slate-800 w-full px-2 py-1"name="email" id="lastNamesign" type="text" placeholder="xyz" onChange={(e) => {
